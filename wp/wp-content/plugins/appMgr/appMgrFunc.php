...
function fast_image_insert() 
{
  ...
  if($compat) {
    add_meta_box('fastinsert', '添加app', 'fast_insert_form', 'post', 'normal', 'high');
    add_meta_box('fastinsert', '添加app', 'fast_insert_form', 'page', 'normal', 'high');
    $ptypes = explode(",",$ptype);
    foreach ($ptypes as $type) add_meta_box('fastinsert', 'Faster Insert', 'fast_insert_form', $type, 'normal', 'high');
  } else {
    add_meta_box('fastinsert', '添加app', 'fast_insert_form_notice', 'post', 'normal', 'high');
    add_meta_box('fastinsert', '添加app', 'fast_insert_form_notice', 'page', 'normal', 'high');
  }
}
